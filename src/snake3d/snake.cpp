...
Snake::Snake(Fruits *fruits, uint8_t start_size, uint8_t cube_size)
...
void Snake::direction(Direction dir) { _dir = dir; }
...
const std::deque<Led> *Snake::snake() const { return &_snake; }

size_t Snake::length() { return _snake.size(); }
